function calcular1() {
  ...
  if (valor >= 0 && valor <= 12581) {
    ...
    resultado2 = 2625.10 //2.055,19 + 467,14 + 102,76
  ...
  } else if (valor >= 45640 && valor <= 506339) {
    resultado2 = 2816,64 // 2.205,19 + 501,24 + 110,26
  } else if (valor >= 506340 && valor <= 556339) {
    resultado2 = 2880.55 // 2.255,19 + 512,60 + 112,76
  } else if (valor >= 556340 && valor <= 606339) {
    resultado2 = 2944.42 // 2.305,19 + 523,97 + 115,26
    ...
    resultado2 = 3519.20 // 2.755,19 + 626,25 + 137,76
    ...
    resultado2 = 3710.80 // 2.905,19 + 660,35 + 145,26
    ...
    resultado2 = 4796.50 // 3.755,19 + 853,55 + 187,76
    ...
    resultado2 = 4988.10 // 3.905,19 + 887,65 + 195,26
  } else if (valor >= 2206340 && valor <= 2256339) {
